...
func NewServer(
	...
	handler.HandleFunc("/user/{address}/delegates/top", srv.getTopDelegates).Methods(http.MethodGet).Name("get_top_delegates")
	handler.HandleFunc("/user/{address}/delegates/{dao_id}/list", srv.getDelegatesList).Methods(http.MethodGet).Name("get_delegates_list")
	handler.HandleFunc("/user/{address}/delegators/top", srv.getTopDelegators).Methods(http.MethodGet).Name("get_top_delegates")
	handler.HandleFunc("/user/{address}/delegators/{dao_id}/list", srv.getDelegatorsList).Methods(http.MethodGet).Name("get_delegators_list")
